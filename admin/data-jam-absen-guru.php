                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <div class="text-right d-none d-lg-block">
                            <a href="data-jam-absen-guru-form.php" class="btn btn-primary"><i class="align-middle mr-2" data-feather="plus-square"></i>Tambah Data</a>
                        </div>
                        <div class="text-right d-block d-lg-none">
                            <a href="data-jam-absen-guru-form.php" class="btn btn-primary btn-sm"><i class="align-middle" data-feather="plus-square"></i></a>
                        </div>
                    </div>
                </div>
            </div>
